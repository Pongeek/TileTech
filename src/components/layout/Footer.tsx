    ...
    <footer className="bg-secondary text-white" dir="rtl">
      ...
      <div className="container-custom py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-[10px] font-heebo text-white/50 tracking-wide">ריצוף ושיפוץ</span>
              </div>
            </div>

            <p className="font-assistant text-white/75 text-sm leading-relaxed mb-6">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 bg-white/10 hover:bg-primary transition-colors duration-200 rounded-full flex items-center justify-center"
              >
              ...
              <a
                ...
                className="w-9 h-9 bg-white/10 hover:bg-[#25D366] transition-colors duration-200 rounded-full flex items-center justify-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-white" viewBox="0 0 30 30">
          ...
          {/* Quick nav */}
          <div>
            <h3 className="text-base font-frank font-bold mb-5 pb-2 border-b border-white/15">ניווט מהיר</h3>
            <ul className="space-y-3 font-assistant">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="flex items-center gap-2 text-white/75 hover:text-primary transition-colors text-sm group">
          ...
          {/* Working hours */}
          <div>
            <h3 className="text-base font-frank font-bold mb-5 pb-2 border-b border-white/15">שעות פעילות</h3>
            <ul className="space-y-3 font-assistant text-sm">
              ...
              <li className="flex justify-between gap-4 text-white/75">
                <span>שבת</span>
                <span className="text-white/40">סגור</span>
              </li>
            </ul>
          </div>
          ...
          {/* Contact info */}
          <div>
            <h3 className="text-base font-frank font-bold mb-5 pb-2 border-b border-white/15">צור קשר</h3>
            <ul className="space-y-4 font-assistant text-sm">
              <li>
                <a href="tel:+972544727746" className="flex items-start gap-3 text-white/75 hover:text-primary transition-colors">
              ...
              <li>
                <a href="mailto:info@tiletech.co.il" className="flex items-start gap-3 text-white/75 hover:text-primary transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mt-0.5 shrink-0 text-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="border-t border-white/10">
        <div className="container-custom py-5 flex flex-col md:flex-row justify-between items-center gap-3 text-xs font-assistant text-white/50">
