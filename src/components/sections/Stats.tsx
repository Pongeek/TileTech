...
const Stats: React.FC = () => {
  ...
  return (
    <section className="bg-secondary py-16" dir="rtl" ref={ref}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-4xl md:text-5xl font-frank font-bold text-white mb-2">
                <CountUp target={stat.value} suffix={stat.suffix} active={isInView} />
              </div>
              <p className="text-white/80 font-assistant text-base md:text-lg">
                {stat.label}
              </p>
            </motion.div>
          ))}
